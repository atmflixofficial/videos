...
function output_post(v,cols){
	...
	var html = '<div class="'+col+' video-item-col v'+v.id+'"><i class="far fa-edit edit-post" data-id="'+v.id+'"></i><a href="/p/watch.html?v='+v.id+'" class="video-list-item" title="'+v.title.rendered+'">';
